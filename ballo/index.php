...
get_header(); ?>
	...
	<!--Banner Content-->
        <div id="banner-content" class="row clearfix" style="background: <?php echo $ballo[ 'header-background' ]; ?>">

            <div class="col-38">

                <div class="section-heading">
                    <h1 style="color:<?php echo $ballo[ 'heading-color' ]; ?>"><?php echo $ballo[ 'header-heading' ]; ?></h1>
                    <h2><?php echo $ballo[ 'sub-content' ]; ?></h2>
                </div>

                <!--Call to Action-->
                <a href="#" class="button"><?php echo $ballo[ 'header-button' ]; ?></a>
                <!--End Call to Action-->
    ...
    <main id="content">
        ...
        <aside id="gallery" class="row text-center scrollto clearfix" data-featherlight-gallery
                ...
                <?php echo do_shortcode( '[Best_Wordpress_Gallery id="5" gal_title="Namar"]' ); ?>  
